...
begin
  ...
  begin
    ...
    begin
      ...
      Test.SaveResults('Результаты тестирования.txt');
    end
    else
      LabelQuestion.Caption := Test.GetNextQuestion;
    ...
    ShowMessage('Пожалуйста, выберите один из вариантов ответа.');
end;
